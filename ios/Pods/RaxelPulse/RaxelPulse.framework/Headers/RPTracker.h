...
+ (void)updateLastLocations:(NSArray<CLLocation *> *)locations aDirect:(double)aDirect aLateral:(double)aLateral aVertical:(double)aVertical gyroX:(double)gyroX gyroY:(double)gyroY gyroZ:(double)gyroZ callback:(void (^)(BOOL))callback callbackBudge:(void (^)(BOOL))callbackBudge;

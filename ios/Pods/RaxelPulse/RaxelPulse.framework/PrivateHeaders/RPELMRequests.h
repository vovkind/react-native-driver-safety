...
+ (void)getMainRequestToELM:(CBCharacteristic*)characteristic peripheral:(RPELMPeripheral*)connectedPeripheral command:(NSString*)commandString completion:(void (^)(NSString *commandResult, BOOL success))completionCommandResult;

- (void)askForPIDs:(CBCharacteristic*)characteristic peripheral:(RPELMPeripheral*)connectedPeripheral completion:(void (^)(NSString *commandResult))completionCommandResult;
